  ...
  return (
    <Card className="rounded-lg border-[#D8DED2] bg-[#EEF4F6] shadow-none">
      <CardHeader>
        ...
        <CardDescription>Быстрый взгляд на удержание учеников.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="rounded-md bg-white p-4">
          <p className="text-xs font-medium uppercase tracking-[0.08em] text-[#66715F]">
            Средняя длина обучения
          </p>
          <p className="mt-2 text-3xl font-semibold leading-none">8,4 мес</p>
        </div>
